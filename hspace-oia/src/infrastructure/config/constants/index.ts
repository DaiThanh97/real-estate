export default {
  ...
  masterValueRelations: [
    ...
    {
      columns: [
        "city_id", "ward_id", "district_id", "street_id", "location_type_id",
        "property_type_id", "property_period_id", "property_using_id",
      ],
      name: "properties",
    },
    {
      columns: [
        "city_id", "ward_id", "district_id", "street_id", "company_id", "street_group_id", "position_group_id",
      ],
    ...
    {
      columns: [
        "city_id", "ward_id", "district_id", "street_id", "company_id",
      ],
    ...
    {
      columns: [
        "plan_type_id", "construction_type_id",
      ],
      name: "inspection_expectation_plan_items",
    },
    {
      columns: [
        "city_id", "ward_id", "district_id", "street_id", "street_group_id", "position_group_id",
      ],
